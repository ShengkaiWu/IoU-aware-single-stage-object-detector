...
data = dict(
    ...
    test=dict(
        ...
        test_mode=True))
# optimizer
optimizer = dict(type='SGD', lr=0.01, momentum=0.9, weight_decay=0.0001) # for batch_size = 16
...
log_level = 'INFO'
work_dir = './work_dirs/retinanet_r50_fpn_1x_4gpu'
load_from = None
resume_from = None
workflow = [('train', 1)]