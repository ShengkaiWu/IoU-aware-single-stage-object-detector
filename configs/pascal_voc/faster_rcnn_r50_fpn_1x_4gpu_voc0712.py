...
model = dict(
    ...
    bbox_head=dict(
        ...
        # loss_cls=dict(
            # type='IOUbalancedCrossEntropyLoss', use_sigmoid=False, loss_weight=1.0, eta=1.0),
        # loss_bbox=dict(type='IoUbalancedSmoothL1Loss', beta=1.0, delta=1.4, loss_weight=2.2),
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_r50_fpn_1x_4gpu_voc0712'
load_from = None
resume_from = None
workflow = [('train', 1)]
